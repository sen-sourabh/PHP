...
<head>
    ...
    <!-- Fontfaces CSS-->
    <link href="<?php echo base_url();?>assets/assets/css/font-face.css" rel="stylesheet" media="all">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="password" name="pass" placeholder="Password" required="required">
                                </div>
                                <div class="login-checkbox">
                                    ...
                                    <label>
                                        <a href="<?php echo base_url();?>forget_password">Forgotten Password?</a>
                                    </label>
                                </div>
