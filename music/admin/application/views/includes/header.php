            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>all_songs">
                                <i class="fas fa-th-list"></i>All Songs
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo base_url();?>add_song">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"><?php echo ucfirst($this->session->userdata('adminuser')[0]->admin_name);?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="<?php echo base_url();?>assets/images/icon/avatar-01.jpg" alt="<?php echo ucfirst($this->session->userdata('adminuser')[0]->admin_name);?>" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#"><?php echo ucfirst($this->session->userdata('adminuser')[0]->admin_name);?></a>
                                                    </h5>
                                                    <span class="email"><?php echo $this->session->userdata('adminuser')[0]->admin_email;?></span>
                                                    <span class="email">Login : <?php echo $this->session->userdata('adminuser')[0]->admin_last_login;?></span>
                                                </div>
                                            </div>
