                                    ...
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="song_singer" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="song_desc" rows="9"  class="form-control"></textarea>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="song_country" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    <input id="file-input" type="file" accept="image/*" name="song_image" class="form-control-file" onchange="ImagePreview()" required="required">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" accept="audio/*" name="song_file" class="form-control-file" required="required">
                                                    <small class="help-block form-text">Please choose file (.mp3 recomended) of this song.</small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <input type="submit" name="add" class="btn btn-primary btn-sm" value="Add Song"/>
