    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Blogs / Add Blog</li>
            </ol>
        </div>
        <!--/.row-->
        <div class="productde">
            <div class="">
                <div class="row">
                        <div class="col-lg-9">
                            <div class="mybts">
                                <h3 class="addme">Add New Blog</h3>
                                <input type="text" name="title" class="form-control" placeholder="Enter Title Here" required="required">
                                <textarea name="desc" class="jqte-test" placeholder="Description"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="box">
