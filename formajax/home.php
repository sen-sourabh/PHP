...
<div class="container">
	<table>
		...
		<tbody>
			...
			?>
			<tr>
				<td><img id="myImg<?php echo $row['id'];?>" data-target="#myModal<?php echo $row['id'];?>" src="img/<?php echo $row['image'];?>" alt="<?php echo $row['name'];?>" style="width:50px;height:50px;"/></td>
...
<div id="myModal<?php echo $row['id'];?>" class="modal">
  ...
  <img class="modal-content" id="img01<?php echo $row['id'];?>">
  <div id="caption<?php echo $row['id'];?>"></div>
</div>
			<?php 
				}
			?>
