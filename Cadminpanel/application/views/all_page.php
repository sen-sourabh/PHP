                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="allpage_doc">
                            <span class="meta2"> Pages</span>
                            <button type="button" onclick="location.href='addnewpage';" class="btn btn-default draftbtn">Add New</button>
                            <div class="row">
                                <div class="col-lg-8">
                                    <ul class="allpageul">
                                        <li><a href="allpage">All </a>(
                                            <?php foreach($countall as $row)
                                            {
                                                echo $row->countall;
                                            }
                                            ?>
                                        )</li>
                                        <li><a href="published"> Published </a>(
                                            <?php foreach($countpublish as $row)
                                            {
                                                echo $row->countpublish;
                                            }
                                            ?>
                                        )</li>
                                        <li><a href="draft">  Draft </a>(
                                            <?php foreach($countdraft as $row)
                                            {
                                                echo $row->countdraft;
                                            }
                                            ?>
                                ...
                                <div class="col-lg-4">
                                    <div class="serc_allpage">
                                            <div class="input-group">
                                                <input id="btn-input" type="text" class="form-control jsrt input-md" placeholder="" name="search_page"/><span class="input-group-btn">
    								            <input name="search" type="submit" class="btn btn-primary btn-md" id="btn-chat" value="Search Pages"/>
    						                    </span>
                                            </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="allpageul">
                                        <li>
                                            <div class="form-group">
                                                <select name="delete_select" class="form-control">
                                        ...
                                        <li>
                                            <input type="submit" name="delete" class="btn btn-default draftbtn" value="Apply"/>
                                        </li>
                                        <li>
                                                <div class="form-group">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="check_all" id="check_all" value=""><a href="#">Title</a>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" class="checkboxid" name="row_id[]" value="<?php echo $row->id;?>">
                                                                        <a href="editpage?id=<?php echo $row->id;?>"/> 
                                                                            <?php echo $row->title;?>
                                                                        </a>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" value=""><a href="#"> Check Out</a>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" value=""><a href="#"> Contacts</a>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </td>
