                    ...
                    <form method="post">
                        ...
                        <div class="col-lg-9">
                            <div class="mybts">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="Enter Titel Here" value="<?php echo $edit->title;?>"/>
                                <textarea name="content" value="<?php echo $edit->content;?>" class="jqte-test"><?php echo $edit->content;?></textarea>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="box">
                                <div class="panel panel-default ">
                                    ...
                                    <div class="panel-body timeline-container">
                                        <input name="updatesave" type="submit" class="btn btn-default draftbtn" value="Save Draft"/>
                                        <button type="button" class="btn btn-default pull-right draftbtn">Preview</button>
                                        <p> <i class="fa fa-map-pin"></i> Status : <?php echo $edit->status;?> <a href="#">Edit</a></p>
                                        <p> <i class="fa fa-eye"></i> Visibilty : Public <a href="#">Edit</a></p>
                                        <p> <i class="fa fa-calendar"></i> Publish immediately <a href="#">Edit</a></p>
                                    </div>
                                    <input name="updatepublish" type="submit" class="btn btn-primary pull-right publisbtn" value="Publish"/>
                                </div>
                            </div>
                            <?php
                                }
                                    ...
                                    <div class="panel-body timeline-container">
                                        <div class="form-group">
                                            ...
                                            <select name="parent" class="form-control">
                                                <option value="<?php //echo $edit->parent;?>"> <?php //echo $edit->parent;?> </option>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="template" class="form-control">
                                                <option value="<?php //echo $edit->template;?>"> <?php //echo $edit->template;?> </option>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <label>Order</label>
                                            <input type="text" name="postorder" placeholder="0" class="form-control" value="<?php //echo $edit->postorder;?>"/>
                                        </div>
                                ...
                                <div class="panel panel-default ">
                                    ...
                                    <div class="panel-body timeline-container">
                                        <div class="categories_uncate">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade in active" id="tab1">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="category[]" <?php if(in_array($row->categories,$cate)){ echo "checked"; }?> value="<?php echo $row->id;?>"/>
                                                                        <?php
                                                                           echo $row->categories;
                                                                        ?>
                                                                    </label>
                                            ...
                                            <!--/.panel-->
                                            <p><a href="#">+ Add New Categories</a></p>
                                        </div>
