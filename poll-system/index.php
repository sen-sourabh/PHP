...
include("configue.php");
	...
	$redirectURL = "http://localhost/phpdoc/poll-system/fb-callback.php";
	$permissions = ['email'];
				...
				<center>
					<h3 style="font-family: candara;"><b>LOGIN</b></h3>
						...
						<form action="userhomepage.php" method="post">
							<input onclick="window.location = '<?php echo $loginURL ?>';" name="loginwithfacebook" type="button" value="Log In With Facebook" class="btn btn-primary"/>
							<br><br>
						</form>
