...
<?php
	if(isset($_POST['update']))
	{
		...
		if(empty($old_password) || empty($new_password) || empty($confirm_password))
		{
			...
			echo "<script>window.loacation='http://localhost/phpdoc/project/admin_change_password.php'</script>";
			...
			if($Id)
			{
				...
				else
				{
					if($_POST['captcha'] == $_POST['write_cap'])
					{
						...
						echo "<script>window.loacation='http://localhost/phpdoc/project/adminhomepage.php'</script>";
					}
					else
					{
