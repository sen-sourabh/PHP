...
$this->load->model("Paypal_model");
             $data['successful_data']=$this->Paypal_model->create($id);*/
// $this->load->view("content/successful",$data);
$this->load->view("content/successful");
...
public function savedata()
	{
		...
		{
		$n=$this->input->post('product_id');
		$e=$this->input->post('doc_id');
		$m=$this->input->post('download_link');
		$this->Paypal_model->saverecords($n,$e,$m);		
		redirect("paypal/success");  
		}
	}	  
