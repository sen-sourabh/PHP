...
<?php
	if(isset($_POST['upload']))
	{
	    ...
	    $ppts_date = date('Y-m-d');
		mysqli_query($con,"INSERT INTO ppts VALUES ('','$email','$title','$desc','$image','$file_doc','$ppts_date')");
