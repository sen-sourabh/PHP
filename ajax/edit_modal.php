  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		...
		<div class="modal-body">
			...
			Lastname: <input type="text" value="<?php echo $nrow['lastname']; ?>" id="ulastname<?php echo $urow['userid']; ?>" class="form-control"><br><br>
			Email: &emsp;&emsp;<input type="email" value="<?php echo $nrow['email']; ?>" id="uemail<?php echo $urow['userid']; ?>" class="form-control">
			
			Phone: &emsp;&nbsp;&nbsp;<input type="text" value="<?php echo $nrow['phone']; ?>" id="uphone<?php echo $urow['userid']; ?>" class="form-control">
			Upload Photo: <input type="file" name="image_file" value="<?php echo $nrow['image']; ?>" id="uimage<?php echo $urow['userid']; ?>" class="form-control">
		</div>
		<br><br>
		<center>	
