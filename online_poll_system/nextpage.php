		...
		<div class="row">&nbsp;
			<form action="" method="post">
				<table class=" table table-striped">
					...
					<?php
						$query = mysqli_query($connection,"SELECT Id,candidate_name FROM reg_for_election WHERE candidate_position = '$position'");
					...
					?>
						<tr>
							...
							<td><input type="radio" name="candidate_name" value="<?php echo $row['candidate_name'];?>"></td>
						</tr>
					<?php
							}
						}
