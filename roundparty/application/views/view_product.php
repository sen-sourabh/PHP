                ...
                <div class="dashbord_tabal">
                    <div class="dashbord_box">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active" >
                              <a data-toggle="tab" href="#editprofile">Add Product</a></li>
                            <li class><a data-toggle="tab" href="#profile">View Product </a></li>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="basic_tab_bx availability_bx">
                                  ...
                                  <form method="post" action="add_product" enctype="multipart/form-data" accept-charset="utf-8">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 create_event_dashboard_button">
                                                <button type="submit" name="addproduct" class="btn cmn_btn_1" value="submit">Add Product</button>
                                            </div>
                                      </form>
                                ...
                                <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="all_evnt_bx">
                                          <div class="col-md-4 col-sm-4 col-xs-12 all_evnt_bx_left">
                                          ...
                                          <div class="col-md-7 col-sm-7 col-xs-12 all_evnt_bx_right">
                                            <div class="evnt_option">
                                              <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu evnt_option_dropdown">
                                                  <li><a href="edit_service?id=<?php echo $row->id;?>">Edit <span><i class="fas fa-edit"></i></span></a></li>
                                                  <li><a href="delete_service?id=<?php echo $row->id;?>">Delete <span><i class="fas fa-trash-alt"></i></span></a></li>
                                                </ul>
                                              </div>
                                            </div>
                                            ...
                                            <ul class="evnt_time_location">
                                                <li><span><i class="far fa-clock"></i></span><?php echo $row->create_date;?></li>
                                                <li><span><i class="fas fa-map-marker-alt"></i></span> <?php echo $row->category;?></li>
                                            </ul>
