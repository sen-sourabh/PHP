		...
		<div class="row">
			...
			<div class="create_event_dashboard">
				<div class="my_default_form create_event_dashboard_form">
                        <?php echo form_open_multipart('Create/create_event'); ?>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<label>Title <small>(Daniel's 3rd Birthday Party)</small></label>
                                <?php 
                                    echo form_input(['class'=>'form-control','name'=>'title','value'=>set_value('title')]);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('title'); ?></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
                                ...
                                <?php 
                                    echo form_input(['class'=>'form-control','name'=>'type','value'=>set_value('type')]);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('type'); ?></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
                                ...
                                <?php 
                                    echo form_input(['class'=>'form-control','name'=>'special_instructions','value'=>set_value('special_instructions')]);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('special_instructions'); ?></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
                                ...
                                <?php 
                                    echo form_input(['class'=>'form-control','name'=>'location','value'=>set_value('location')]);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('location'); ?></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
                                ...
                                <?php 
                                    echo form_input(['class'=>'form-control','name'=>'location_postcode','value'=>set_value('location_postcode')]);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('location_postcode'); ?></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
                                ...
                                <?php 
                                    echo form_input(['class'=>'form-control','name'=>'age','value'=>set_value('age')]);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('age'); ?></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<label>Date</label>
                                <?php 
                                    echo form_input(['type'=>'date','class'=>'form-control','name'=>'event_date','value'=>set_value('event_date')]);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('event_date'); ?></div>
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
                                ...
                                <?php 
                                    ...
                                    echo form_dropdown('start_time',$options);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('start_time'); ?></div>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
                                ...
                                <?php 
                                    ...
                                    echo form_dropdown('end_time',$option);
                                ?>
                                <div class="err" style="color:red;"><?php echo form_error('end_time'); ?></div>
							</div>
						</div>
									...
									<div class="row">
	  									<div class="imgUp">
											...
											<label class="btn">Upload
                                                <?php 
                                                      echo form_upload(['name'=>'image[]','class'=>'uploadFile img','value'=>set_value('image[]'),'style'=>'width: 0px;height: 0px;overflow: hidden;']);
                                                    ?>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 create_event_dashboard_button">
                            <?php echo form_button(['type'=>'submit','content'=>'Create Event','name'=>'create','class'=>'btn cmn_btn_1','value'=>'submit']);?>
