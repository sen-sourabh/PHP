                        ...
                        <div class="user_dsbrd_area_left">
                            ...
                            <div class="user_profile_name">
                                <form class="is-readonly" id="edit_name">
                                    <input type="text" class="form-control is-disabled" value="<?php echo $row->name;?>" disabled="disabled">
                                    <select class="form-control is-disabled" id="slct_gender" disabled="disabled">
                        ...
                        <div class="user_dsbrd_area_right">
                            <div class="dashbord_box">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#dashboardprofile">Change Password</a></li>
                                </ul>
                                                           ...
                                                           <ul>
                                                              <li><span>Current password :</span>
                                                                ...
                                                                <div class="prfl_btn_area">
                                                                    <button name="user_save_password" type="submit" class="btn cmn_btn_1" value="save" >Save</button>
                                                                </div>
                                                           </ul>
                                                       </form>
                                                       </div>
