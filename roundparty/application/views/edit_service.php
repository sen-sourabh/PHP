                ...
                <div class="dashbord_tabal">
                    <div class="dashbord_box">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#editprofile">Edit Service</a></li>
                        </ul>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="basic_tab_bx availability_bx">
                                  <h3>Edit Service</h3>
                                  <form method="post" action="edit_service" enctype="multipart/form-data" accept-charset="utf-8">
                                    <?php 
                                        foreach($service_edit as $edit)
                                        {
                                    ?>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <div class="form-group">
                                                ...
                                                <select name="service_name" class="form-control">
                                                    <option value="<?php echo $edit->service_name;?>"><?php echo $edit->service_name;?></option>
                                                    <option value="Services offered">Select Service Name</option>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <div class="form-group">
                                                ...
                                                <select name="service" class="form-control">
                                                    ...
                                                    <option value="Services offered">Select Service</option>
                                                    ...
                                                    <option value="Vanues">Vanues</option>
                                                    ...
                                                    <option value="Ice cream machines
                                                    ">Ice cream machines
                                                    </option>
                                                    <option value="Soft play equipment">Soft play equipment</option>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <div class="form-group">
                                                <label>Description</label>
                                                    <textarea name="description" cols="40" rows="10" class="form-control" value="<?php echo $edit->description;?>"><?php echo $edit->description;?></textarea>
                                                </select>
                                                <div class="err" style="color:red;"></div>
                                              </div>
                                            </div>
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="imgUp">
                                                        <div class="imagePreview">
                                                            <img class="imagePreview" src="<?php echo base_url();?>/img/<?php echo $imagea[$i];?>" alt="<?php echo $imagea[$i];?>"/>
                                                        </div>
                                                        <label class="btn">Upload
                                                            <input type="file" name="image[]" class="uploadFile img" value="<?php echo $imagea[$i];?>" style="width: 0px;height: 0px;overflow: hidden;"/>
                                                        </label>
                                                        <input type="hidden" name="del_image[]" value="<?php echo $imagea[$i];?>"/>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 create_event_dashboard_button">
                                                <button type="submit" name="update_service" class="btn cmn_btn_1" value="submit">Update Service</button>
                                            </div>
                                        <?php 
                                            }
                                        ?>
