                ...
                <div class="dashbord_tabal">
                    <div class="dashbord_box">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active" >
                              <a data-toggle="tab" href="#editprofile">Add Service</a></li>
                            <li class><a data-toggle="tab" href="#profile">View Service </a></li>
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="basic_tab_bx availability_bx">
                                  ...
                                  <form method="post" action="add_service" enctype="multipart/form-data" accept-charset="utf-8">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <div class="form-group">
                                                <label>Service Name </label>
                                                <select name="service_name" class="form-control">
                                                    <option value="Services offered">Services Category</option>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 create_event_dashboard_button">
                                                <button type="submit" name="addservice" class="btn cmn_btn_1" value="submit">Add Service</button>
                                            </div>
                                      </form>
                                </div>
                              </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $ser->create_date;?></td>
                                                            <td>
                                                                <?php
                                                                $images = $ser->image;
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu evnt_option_dropdown">
                                                                      <li><a href="edit_service?id=<?php echo $ser->id;?>">Edit <span><i class="fas fa-edit"></i></span></a></li>
                                                                      <li><a href="delete_service?id=<?php echo $ser->id;?>">Delete <span><i class="fas fa-trash-alt"></i></span></a></li>
                                                                    </ul>
                                                                  </div>
                                                              </td>
                                                        </tr>
