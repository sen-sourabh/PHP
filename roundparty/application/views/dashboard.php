                        ...
                        <div class="user_dsbrd_area_left">
                            ...
                            <div class="user_profile_name">
                                <form class="is-readonly" id="edit_name">
                                    <input type="text" class="form-control is-disabled" id="name" name="name" value="<?php echo $row->name;?>" disabled="disabled">
                                    <select name="gender" class="form-control is-disabled" id="slct_gender gender" disabled="disabled">
                        ...
                        <div class="user_dsbrd_area_right">
                            <div class="dashbord_box">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#dashboardbooking">Bookings</a></li>
                                    <li><a data-toggle="tab" href="#dashboardwallet">Wallet</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div id="dashboardbooking" class="tab-pane fade in active">
                                        <div class="past_booking_area">
                                            <h3 class="past_booking_area_heading">Past Bookings</h3>
                                            <ul>
                                                <li>
                                                    <div class="past_booking_bx">
                                                        <div class="past_booking_bx_left">
                                                            <h3>Aug 13</h3>
                                                            <h4>12:45 AM</h4>
                                                        </div>
                                                        <div class="past_booking_bx_right">
                                                            <h1>Sam Birthday Parties</h1>
                                                            <h2>Birthday</h2>
                                                        </div>
                                                    </div>
                                                </li>
                                    ...
                                    <div id="dashboardwallet" class="tab-pane fade">
                                        <div class="usr_wallet_area">
        ...
        function save_user_info()
        {
            $('.js-save').on('click', function(){
                ...
                var gender=$('#gender').val();
                    $.ajax({
                        type: 'POST',
                        url: '<?php //echo base_url("Create/quick_update_user_profile")?>',
