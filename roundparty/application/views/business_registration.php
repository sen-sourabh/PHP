...
<head>
    ...
    <!-- <link href="http://itsolution.co.in/roundparty_new/assets/css/select2.min.css" rel="stylesheet" /> -->
</head>
<body>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="top_bar_right">
                                <ul>
                                    ...
                                    <li><a href="http://itsolution.co.in/roundparty_new/Supplier_controller/business_registration"><span><i class="fas fa-phone"></i></span> Register Your Business</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
      ...
      <div class="container-fluid">
          <div class="row">
              <div class="col-md-5 col-sm-5 col-xs-12 no_padding">
                  <div class="register_area_left my_form_left">
                      <div class="my_form_left_overlay">
            ...
            <br/><br/>
              ...
              <div class="col-md-7 col-sm-7 col-xs-12 no_padding">
                  <div class="register_area_right my_form_right">
                      <div class="my_heading">
                          <h1>Register your business</h1>
                      </div>                    
                    <?php echo form_open('Create/addbusinessinfo'); ?>
                        <div class="err" style="color:red;"><?php echo form_error('business_name'); ?></div>
                        <input class="form-control" placeholder="Name Of Business" type="text" name="business_name"/>
                        <div class="err" style="color:red;"><?php echo form_error('contact_name'); ?></div>
                        <input class="form-control" placeholder="Contact Person Name" type="text" name="contact_name"/> 
                        <div class="err" style="color:red;"><?php echo form_error('contact_phone'); ?></div>
                        <input class="form-control" placeholder="Contact Phone" type="text" name="contact_phone"/>
                        <div class="err" style="color:red;"><?php echo form_error('service'); ?></div>
                        <select class="form-control" name="service">
                          <option value="">Category</option>
                          <option vlaue="Venues">Venues</option>
                          <option vlaue="Product">Product</option>
                          <option vlaue="Service">Service</option>
                        </select>
                        <!-- <div class="err" style="color:red;"><?php //echo form_error('service_option'); ?></div> -->
                        <div class="mutliple_select_box_in_ci">
                          <select name="service_option[]" class="selectpicker" id="multi_data" multiple="multiple" data-live-search="true">
                            <option value="Ballons">Ballons</option>
                            <option value="Magician">Magician</option>
                            <option value="Ballon Model">Ballon Model</option>
                            <option value="Face Painting">Face Painting</option>
                            <option value="Bubble Performer">Bubble Performer</option>
                            <option value="Venues">Venues</option>
                            <option value="Clowns">Clowns</option>
                            <option value="Carcaturist">Carcaturist</option>
                            <option value="Bouncy Castle">Bouncy Castle</option>
                            <option value="Mascots">Mascots</option>
                          </select>
                        </div>
                          <script type="text/javascript">
                            $('#multi_data').selectpicker();
                          </script>
				        <div class="err" style="color:red;"><?php echo form_error('areas_served'); ?></div>
                        <input class="form-control" type="text" placeholder="Areas Served" name="areas_served"/>
                        <div class="err" style="color:red;"><?php echo form_error('email'); ?></div>
                        <input class="form-control" placeholder="Email Address" type="email" name="email"/>
                        <div class="err" style="color:red;"><?php echo form_error('password'); ?></div>
                        <input class="form-control" placeholder="Choosen Password" type="password" name="password"/>
                        <div class="err" style="color:red;"><?php echo form_error('business_address'); ?></div>
                        <textarea class="form-control" type="text" placeholder="Address of Business" name="business_address"></textarea>
                        <div class="err" style="color:red;"><?php echo form_error('post_code'); ?></div>
                        <input class="form-control" type="text" placeholder="Postal Code" name="post_code"/>

                        <br>
                        <input class="btn cmn_btn_1" type="submit" name="register" value="Register Business"/>
                    <?php echo form_close(); ?>
                </div>
              </div>
          </div>
...
<div class="footer">
  ...
  <script src="http://itsolution.co.in/roundparty_new/assets/js/full-calender.js"></script> 
    ...
    <!-- <script type="text/javascript" src="http://itsolution.co.in/roundparty_new/assets/js/select2.min.js"></script> -->
