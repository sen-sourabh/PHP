                    ...
                    <form method="post" enctype="multipart/form-data">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="special_instructions" value="<?php echo $row->special_instructions;?>"/>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="location_postcode" value="<?php echo $row->location_postcode;?>"/>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<label>Date</label>
								<input type="date" class="form-control" value="<?php echo $row->event_date;?>" name="event_date"/>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								...
								<select name="start_time">
                                    <?php
                                        echo $row->start_time;
                                        $stft = $row->start_time;
                                        $start_time_modify = date("h:i A",strtotime($stft));
                                    ?>
                                    <option value="<?php echo $start_time_modify;?>"><?php echo $start_time_modify;?></option>
									<option> - - - </option>
							...
							<div class="form-group">
								...
								<select name="end_time">
                                    <?php
                                        echo $row->end_time;
                                        $etft = $row->end_time;
                                        $end_time_modify = date("h:i A",strtotime($etft));
                                    ?>
                                    <option value="<?php echo $end_time_modify;?>"><?php echo $end_time_modify;?></option>
									<option> - - - </option>
									<option value="08:00 AM">08:00 AM</option>
                                    <option value="09:00 AM">09:00 AM</option>
                                    <option value="10:00 AM">10:00 AM</option>
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
	  									<div class="imgUp">
											...
											<label class="btn">Upload<input type="file" name="image[]" class="uploadFile img" value="<?php echo $imagea[$i];?>" style="width: 0px;height: 0px;overflow: hidden;"/></label>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 create_event_dashboard_button">
							<button name="update_event" class="btn cmn_btn_1" value="submit">Update Your Event</button>&emsp;
