                ...
                <div class="top_bar_in">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                      ...
                                                      <ul class="user_welcome">
   
                                <li><a href="#"><span><i class="fas fa-user"></i></span> Welcome <span class="orange">Sourabh Sen</span></a></li>
                                <li><a href="http://itsolution.co.in/roundparty_new/logout"><span><i class="fas fa-sign-out-alt"></i></span> Logout</a></li>
                                <li class="dropdown">
                                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span><i class="fa fa-user"></i></span> <span class="caret"></span></a>
                                      <ul class="dropdown-menu">
                                        <li><a href="dashboard">Dashboard </a></li>
                                        <li><a href="dashboard_profile">View profile </a></li>
                                        <li><a href="user_edit_profile">Edit profile </a></li>
                                        <li><a href="user_changepassword">Change Password</a></li>
                                        <li><a href="#">Terms & Conditions </a></li>
                                        <li><a href="delete_user_account">Delete account </a></li>
                                      </ul>
                                </li>
                            </ul>
                             </div>
...
<div class="my_pg_wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="user_dsbrd_area">
                    <?php 
                        foreach($user_data as $row)
                        {
                    ?>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="user_dsbrd_area_left">
                            <div class="user_profile_pic">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url(<?php echo base_url();?>/img/<?php echo $row->image;?>);">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="user_profile_name">
                                <form class="is-readonly" id="edit_name">
                                    <input type="text" name="name" class="form-control is-disabled" value="<?php echo $row->name;?>" disabled="disabled">
                                    <select name="gender" class="form-control is-disabled" id="slct_gender" disabled="disabled">
                                       <option value="<?php echo $row->gender;?>"><?php echo $row->gender;?></option>
                                       <option value=""> ---- </option>
                                       <option value="Male">Male</option>
                                       <option value="Female">Female</option>
                                    </select>
                                  <button onclick="location.href='user_edit_profile'" type="button" class="btn btn-edit">Edit</button><!--Previous class="js-edit" in both buttons-->
                                  <!-- <button type="button" class="btn btn-save js-save">Save</button> -->
                                </form>
                            </div>
                            <div class="user_profile_login_info">
                                <h5>Login Info</h5>
                                <h2><?php echo $row->email;?></h2>
                                <h4><a href="user_changepassword">Reset password</a></h4>
                            </div>
                        </div>
                    </div>
                    <?php 
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class="user_dsbrd_area_right">
                            <div class="dashbord_box">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#dashboardprofile">Edit Profile</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div id="dashboardprofile" class="tab-pane fade in active">
                                        <div class="past_booking_area">
                                            <?php 
                                                foreach($user_data as $edit)
                                                {
                                            ?>
                                            <div class="row">
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                           <ul>
                                                            ...
                                                            <li><span>Date of birth</span>
                                                                <input type="date" name="dob" value="<?php echo $edit->dob;?>" class="form-control"  />
                                                            </li>
                                                             <li><span>Gender :</span>
                                                            ...
                                                            <li><span>Mobile number :</span>
                                                              ...
                                                              <li><span>Billing address :</span>
                                                                <input type="text" name="billing_address" value="<?php echo $edit->billing_address;?>" class="form-control"/>
                                                              </li>
                                                              <li><span>Other address :</span>
                                                                <input type="text" name="other_address" value="<?php echo $edit->other_address;?>" class="form-control"  />
                                                              </li>
                                                               <li><span>Profile Image :</span>
                                                                <br>
                                                                <input type="file" name="profile_image" value="<?php echo $edit->image;?>"/><?php echo $edit->image;?>
                                                              </li>
                                                              <div class="prfl_btn_area">
                                                                    <button name="user_save_profile" type="submit" class="btn cmn_btn_1" value="Save" >Save</button>
                                                              </div>
                                                           </ul>
                                                       </form>
                                                       </div>
