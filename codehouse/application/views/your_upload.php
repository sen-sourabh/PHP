...
<div class="fluid-container">
  <div class="container1">
    ...
    <div class="overlay">
      <center>
        <h2 class="page_head_rooms">Your Uploads</h2>
        <form method="post" id="search_form">
          <div class="input-group mb-3">
            <input type="text" class="form-control searchbox" name="searchboxuserdata" placeholder="Search">
            <div class="input-group-append">
              <input class="btn btn-success searchbox" name="searchuserdata" type="submit" value="Search"/>
            </div>
          </div>
  ...
  <div id="blogs">
    <div class="container">
      <div class="row" id="card-row">
        <div clas="col-lg-6 col-xl-6 col-md-12 col-sm-12 col-12" style="float:right;margin:10px;padding:10px;max-width:100%;width:38%;height:auto;">
          <img class="card-img-top" style="width:100%;height:100%;" src="<?php echo base_url();?>assets/img/<?php echo $row->image;?>" alt="Card image"/>
        </div>
        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12 col-12" style="width:100%;height:auto;padding:14px;">
          ...
          <a style="margin-top:5px;" href="<?php echo base_url("index.php/Web/edit_post?id=$row->id");?>" class="btn btn-info">Edit</a>
          <a style="px;margin-top:5px;" href="<?php echo base_url("index.php/Web/deletepost?id=$row->id");?>" class="btn btn-danger">Delete</a>
        </div>
      </div>
      <hr>
    </div>
