...
<div class="topnav" id="myTopnav">
  ...
  <a href="changepassword" class="active">
...
<div class="fluid-container">
  <div class="container1">
    ...
    <div class="overlay">
      <center>
        <h2 class="page_head">Change Password</h2>
      </center>
    </div>
  </div>
</div>
  ...
  <hr class="hr_underline">
    <div class="row">
      <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12 col-12">
        <?php 
          if($change = $this->session->flashdata('Change'))
          {
        ?>
          <div class="alert alert-success alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Fine! </strong><?php echo $change; ?></div>
        <?php
          }
          else if($no_match = $this->session->flashdata('Not_match'))
          {
        ?>
          <div class="alert alert-warning alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Sorry! </strong><?php echo $no_match; ?></div>
        <?php 
          }
          else if($old_match = $this->session->flashdata('Not_match_old'))
          {
        ?>
          <div class="alert alert-danger alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Sorry! </strong><?php echo $old_match; }?></div>
      </div>
    </div>
  </div>
  <br>
  ...
  <div class="row">
    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12 col-12">
      <form method="post">
        ...
        <br>
        <input class="form-control" type="password" name="newpass" required="required" placeholder="New Password"/>
        <br>
        <input class="form-control" type="password" name="cnewpass" required="required" placeholder="Confirm New Password"/>
        <br>
        <input class="btn btn-primary chang" type="submit" name="changepass" value="Change"/>
        <input class="btn btn-default chang" type="reset" name="reset" value="Reset"/>
      </form>
    </div>
  </div>
</div>
