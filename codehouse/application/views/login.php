...
<div class="fluid-container">
  ...
  <br>
  <div class="container">
    <h2 class="heading2">Login form</h2>
    ...
    <div class="container">
      <div class="row">
        <?php 
          ...
          {
        ?>
          <div class="alert alert-warning alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Sorry! </strong><?php echo $error; ?></div>
        <?php
          }
          else if($page_error = $this->session->flashdata('Logout'))
        {
      ?>
        <div class="alert alert-danger alert-dismissible fade show"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Sorry! </strong><?php echo $page_error; }?></div>
      </div>
    </div>
  </div>
  <br>
    ...
    <div class="row">
      <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12 col-12">
        <form method="post">
          ...
          <br>
          <input class="btn btn-primary log" type="submit" name="login" value="Login"/>
          <input class="btn btn-default log" type="reset" name="reset" value="Reset"/>
        </form>
      </div>
    </div>
</div>
