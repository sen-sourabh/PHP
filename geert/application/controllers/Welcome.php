...
class Welcome extends CI_Controller {
    ...
    $data['slider_data'] = $this->My_model->getSliderData();
    $data['top_banner_data'] = $this->My_model->getTopBannerData();
    $data['bottom_banner_data'] = $this->My_model->getBottomBannerData();
		$data['productlist'] = null;
    if($this->input->post('searchproduct'))
    {
        $search_query = $this->input->post('search_query');
  
        $result['productlist']=$this->My_model->getSearchResultArray('product',array('product_status'=>'active'),$search_query);
        $this->load->view('search_product',$result);
    }
		else if($query)
    {
  			$data['productlist'] =  $query;
        $data['shop_banner_data'] = $this->My_model->getShopBannerData();
	...
	public function shop($data = array())
	{
    $result['about_data'] = $this->My_model->getAboutData();
    $result['contact_data'] = $this->My_model->getContactData();
		$this->load->view('header',$result);
    ...
    {
        $cat_id=$_GET['cat_id'];
        $query=$this->My_model->getAllResultArray('product',array('product_status'=>'active', 'cat_id'=> $cat_id ));
    }
    ...
    if($this->input->post('searchproduct'))
    {
        ...
        $data['productlist']=$this->My_model->getSearchResultArray('product',array('product_status'=>'active'),$search_query);
    }
	...
	public function contact(){
      ...
      else
      {
        ...
        $data['contact_data'] = $this->My_model->getContactData();
