                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="top_bar_left">
                            <ul>
                                ...
                                <li><a href="#">MAIL INFO : <?php echo $row->widget_contact_email;?></a></li>
                                <?php
                                    }
                                ?>
                            </ul>
                  ...
                  <div class="logo_area_center">
                    <form method="post">
                        <div class="input-group">
                            <input type="hidden" class="form-control" name="searchproduct" placeholder="Product Name" value="addwidget">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown ctgry_li">
                              ...
                              <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url(); ?>shop?cat_id=3">Stickers</a></li>
                                <li><a href="<?php echo base_url(); ?>shop?cat_id=4">T-shirts</a></li>
                                <li><a href="<?php echo base_url(); ?>shop?cat_id=1">Posters</a></li>
                                <li><a href="<?php echo base_url(); ?>shop?cat_id=2">Hangers</a></li>
                              </ul>
                            </li>
